...
### C++ 
Have programming experience in C++ for *around 4 years*. Created **one side project** for a portfolio.

Link to the project can be found [here](https://github.com/InvertedVoice/IceMan-Project.git)
### Javascript
Basic knowledge of Java for *a year*. 

## Goals
- [X] Obtain an Associate of Science in Computer Science.
- [] Complete Bachelor of Science for Computer Science.
